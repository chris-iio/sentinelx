...
- [ ] M014: Local workflow hardening and recovery loop — S01-S03 complete: the runtime boundary is explicit and verified, the repo has a supported repair entrypoint with safe deindex/quarantine behavior, and the supported local dev loop now provides explicit crash detection and cheap restart recovery; S04 remains to do final closure and review/refactor.

---
*Last updated: 2026-04-25 — M014 active with S01-S03 complete; runtime-state repair and the supported dev-server lifecycle are shipped and verified, with final closure work remaining.*
