...
Plans:
- [x] 04-01-PLAN.md — Verdict clarity UX: badge labels, no-data collapsed section, progress counter, per-provider loading
- [x] 04-02-PLAN.md — Security audit tests: CSP, template safety, HTTP safety verification
